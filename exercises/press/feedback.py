...
FEEDBACK_TEMPLATES: dict[str, FeedbackTemplate] = {
    "press_symmetry": FeedbackTemplate(
        ...
        simple_fix="Press both weights at the same speed so they finish together.",
    ...
    "press_alignment": FeedbackTemplate(
        ...
        simple_issue="Your wrist drifts out of line with your elbow on {reps}.",
        why="A wrist in line with the elbow sends the weight straight up.",
    ...
    "press_rom": FeedbackTemplate(
        ...
        simple_fix="Press until your arms are straight overhead. Then lower them to shoulder height.",
