...
FEEDBACK_TEMPLATES: dict[str, FeedbackTemplate] = {
    "depth": FeedbackTemplate(
        ...
        simple_fix="Lower until your hips reach about knee height. Keep your whole foot flat.",
    ...
    "torso_lean": FeedbackTemplate(
        ...
        simple_issue="Your chest tips forward as you go down on {reps}.",
        why="An upright chest keeps the work in your legs.",
        simple_fix="Tighten your stomach and keep your chest up as you go down.",
    ...
    "heel_lift": FeedbackTemplate(
        ...
        simple_fix="Keep your whole foot flat and push through the middle of your foot.",
    ...
    "extension": FeedbackTemplate(
        ...
        simple_issue="You begin the next rep before standing up fully on {reps}.",
