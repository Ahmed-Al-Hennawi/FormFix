...
HEADLINE = (
    "See your form.",
    "Understand <em>your movement.</em>",
    "Improve your technique.",
)

SUBTITLE = (
    "FormFix analyses a short video of your squat,dumbbell shoulder press or lat "
    "pulldown, tracks how your body moves, and explains - in plain language - "
            ...
            <section class="hero" id="ff-top">
              <div class="hero__inner">
                <div class="hero__copy">
                  <p class="eyebrow reveal">Explainable computer vision &middot; For people learning to lift</p>
                ...
                <div class="hero__stage">
                  ...
                  <figure class="hero__figure" data-depth="1">
                    <img src="{asset_url(SQUAT.image)}"
                         alt="Athlete performing a barbell squat, analysed by FormFix" />
                    {pose}
              ...
              <a class="hero__scroll-hint" href="#ff-about" data-scroll-to="ff-about"
